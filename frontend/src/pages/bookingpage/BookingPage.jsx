...
import { ChevronDown, ArrowLeft, ShieldCheck, Landmark } from "lucide-react";
...
export default function BookingPage() {
  ...
  if (!activeService) return <div className="min-h-screen bg-[#020617]" />;
            ...
            <div className="space-y-10">
              <div>
                ...
                <p className="text-4xl sm:text-[16px] text-slate-400 tracking-tighter mb-6">
                  ...
                  assess strategic fit and clarify whether , deeper
