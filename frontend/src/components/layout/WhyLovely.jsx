...
export default function WhyLovely() {
  ...
  const [isMobile, setIsMobile] = useState(false); // Track mobile for auto-color
    ...
    >
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 md:px-12 flex flex-col lg:flex-row justify-between items-center gap-12 lg:gap-24">
        ...
        <div className="flex-[0.8] lg:flex-[1.2] relative w-full flex items-center justify-center lg:justify-end perspective-2000 order-1 lg:order-2">
          <div
            ref={imageCardRef}
            className="relative w-full max-w-[320px] sm:max-w-[450px] lg:max-w-[580px] aspect-[4/5] z-10 shadow-2xl group"
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <motion.img
                    ...
                    // Mobile: Auto-pulse Grayscale and Brightness
                    // Desktop: Controlled by group-hover classes
                    animate={
                      isMobile
                        ? {
                            filter: [
                    ...
                    className={`w-full h-full object-cover transition-all duration-1000 ease-in-out
                      ${!isMobile ? "grayscale brightness-50 group-hover:grayscale-0 group-hover:brightness-100" : ""}`}
                  />
                </motion.div>
              </AnimatePresence>
