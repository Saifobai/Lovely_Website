        ...
        <AnimatePresence>
          {mobileOpen && (
            <motion.div
              ...
              className="absolute top-[110%] left-0 w-full bg-black/90 backdrop-blur-3xl border border-white/10 rounded-2xl p-8 md:hidden overflow-hidden shadow-2xl"
            >
              ...
              {/* Decorative HUD element for mobile menu */}
              <div className="mt-8 pt-6 border-t border-white/5 flex justify-between items-center text-[8px] font-mono text-white/20 uppercase tracking-[0.2em]">
                <span>Status: Connected</span>
                <span>LS_Mobile_v1.0</span>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
