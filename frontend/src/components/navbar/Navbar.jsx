...
//           className="flex items-center gap-2 group cursor-pointer shrink-0 transition-transform active:scale-95"
//         >
//           <div className="w-12 h-12 bg-gradient-to-br from-blue-600/20 to-blue-400/10 rounded-lg flex items-center justify-center transition-transform duration-500 group-hover:rotate-[90deg] shadow-[0_0_15px_rgba(37,99,235,0.2)] border border-white/5 overflow-hidden">
//             <img
//               src={LogoImage}
//               alt="Logo"
//               className="w-full h-full object-contain p-1.5"
...
//           </div>
//           <div className="flex flex-col leading-none">
//             <span className="ml-2 text-4xl font-black tracking-tighter uppercase text-white italic">
//               Lovely
//             </span>
//             <span className="ml-2 text-[11px] font-mono text-slate-400 tracking-[0.3em] uppercase opacity-40 group-hover:opacity-100">
//               Boutique_Consulting
//             </span>
//           </div>
//         </a>
...
//       href={href}
//       onClick={onClick}
//       className="flex items-start gap-1 py-2 text-[20px] font-bold uppercase tracking-[0.2em] text-slate-400 hover:text-white transition-colors"
//     >
//       <span className="text-[7px] font-mono text-blue-500 mt-0.5 opacity-50 group-hover:opacity-100"></span>
//       {label}
//     </a>
//     <span className="absolute bottom-0 left-0 w-full h-[1px] bg-blue-500 scale-x-0 origin-right transition-transform duration-500 group-hover:scale-x-100 group-hover:origin-left" />
//   </li>
