...
//       {/* NARRATIVE */}
//       <div className="grid lg:grid-cols-12 gap-16 mb-32 items-start px-6">
//         <div className="lg:col-span-5 border-l border-[#C2413A]/40 pl-8">
...
//             A boutique advisory for high-stakes, <br /> cross-border decisions.
//           </h3>
//         </div>
...
//                 <span className="text-base text-[#9CA3AF] italic">{point}</span>
//               </div>
//             ))}
//           </div>
//         </div>
...
//       {/* Reduced Height Container: Changed aspect-[4/5] to aspect-[5/6] */}
