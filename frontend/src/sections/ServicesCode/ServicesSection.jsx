...
//   },
//   sustainability: {
//     gradient: "linear-gradient(135deg, #0B1320, #14532D)",
//     accent: "#3B82F6",
//   },
// };
...
//       { id: "06", key: "sustainability", visual: portalVisuals.sustainability },
//     ],
//     [],
//   );
...
//             exit={{ opacity: 0 }}
//             onClick={onClose}
//             className="fixed inset-0 bg-[#020617]/95 backdrop-blur-xl z-[200]"
//           />

//           {/* Modal wrapper */}
//           <div className="fixed inset-0 z-[201] flex items-center justify-center px-3 md:px-6">
//             <motion.div
...
//               className="
//                 bg-[#0B1320] border border-[#1F2937]
//                 w-full max-w-5xl
//                 h-[85vh] md:h-[65vh]
...
//                 {/* Title */}
//                 <div className="absolute bottom-4 md:bottom-6 left-5 md:left-10 right-16 md:right-20">
//                   <h3 className="text-2xl md:text-4xl font-black uppercase italic text-white leading-tight">
//                     {t(`services.list.${service.key}.title`)}
//                   </h3>
//                   <p className="text-sm md:text-lg font-semibold italic text-slate-300">
...
//                 <button
//                   onClick={onClose}
//                   className="absolute top-4 md:top-8 right-4 md:right-8 w-10 h-10 md:w-12 md:h-12 rounded-full bg-[#0B1320] border border-[#1F2937] flex items-center justify-center hover:bg-[#3B82F6]"
//                 >
//                   <X size={18} />
//                 </button>
//               </div>
...
//               {/* Content */}
//               <div className="flex-1 overflow-y-auto p-6 md:p-20 space-y-8 md:space-y-12">
//                 {data.sections &&
//                   Object.values(data.sections).map((section, i) => (
//                     <div key={i} className="space-y-4">
//                       <h4 className="text-[#F5F7FA] text-sm md:text-lg font-bold uppercase">
//                         {section.title}
//                       </h4>

//                       {section.items && (
//                         <ul className="space-y-2 text-[#9CA3AF] text-sm md:text-base">
...
//                 {data.items && (
//                   <ul className="space-y-3 text-[#9CA3AF] text-sm md:text-base">
...
//               {/* Footer */}
//               <div className="p-5 md:p-8 bg-[#111827]/50 border-t border-[#1F2937] flex justify-center md:justify-end">
//                 <button
//                   onClick={() => navigate(`/book?service=${service.key}`)}
//                   className="
//                     w-full md:w-auto
//                     px-10 md:px-12 py-4 md:py-5
//                     bg-[#3B82F6] text-white
//                     font-black text-[11px] tracking-[0.3em]
//                     rounded-2xl
