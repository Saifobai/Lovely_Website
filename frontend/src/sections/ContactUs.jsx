...
//               whileInView={{ opacity: 1 }}
//               transition={{ delay: 0.3 }}
//               className="text-[#9CA3AF] text-xl md:text-2xl max-w-md leading-relaxed border-l border-[#C2413A]/40 pl-8 italic font-light"
//             >
//               {t("contact.description")}
//             </motion.p>
//           </div>
...
// const MetricBox = ({ icon, label, value }) => (
//   <div className="bg-[#111827]/40 border border-[#1F2937] p-4 rounded-2xl group transition-all duration-500">
//     <div className="text-[#3B82F6] mb-1 opacity-50 group-hover:opacity-100 transition-opacity">
//       {icon}
//     </div>
//     <p className="text-[8px] text-[#4B5563] uppercase font-bold font-mono tracking-widest">
//       {label}
//     </p>
//     <p className="text-[#F5F7FA] text-sm font-bold font-mono">{value}</p>
//   </div>
// );
...
//               <span
//                 className={`relative z-10 font-black uppercase text-xs tracking-[0.4em] flex items-center justify-center gap-3 transition-colors ${!isFormValid ? "text-[#4B5563]" : "text-black group-hover:text-white"}`}
//               >
//                 {status === "loading"
//                   ? "Transmitting..."
//                   : t("contact.form.submit")}
