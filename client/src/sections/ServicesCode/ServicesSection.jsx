...
// // Visual styles mapped to the service keys
// const portalVisuals = {
//   business: {
//     gradient: "linear-gradient(135deg, #1c1c84, #000068)",
//     accent: "#3b82f6",
...
//   // 🟢 DYNAMICALLY TRANSLATED SERVICES ARRAY
...
//               <div className="relative z-10 flex-1">
//                 <h3 className="text-2xl md:text-5xl font-black uppercase italic tracking-tighter group-hover:scale-105 transition-all duration-500 origin-left">
//                   {service.title}
//                 </h3>
